 ...
 * @author asus
 */
public class VerificarDesempenho extends javax.swing.JFrame {

    /**
     * Creates new form VerificarDesempenho
     */
    public VerificarDesempenho() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(461, 226));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerificarDesempenho.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VerificarDesempenho().setVisible(true);
            }
        });
    }
