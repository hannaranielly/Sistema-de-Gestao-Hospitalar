 ...
 * @author leone
 */
public class DelPaciente extends javax.swing.JFrame {

    /**
     * Creates new form DelPaciente_Medico
     */
    public DelPaciente() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DelPaciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DelPaciente().setVisible(true);
            }
        });
    }
